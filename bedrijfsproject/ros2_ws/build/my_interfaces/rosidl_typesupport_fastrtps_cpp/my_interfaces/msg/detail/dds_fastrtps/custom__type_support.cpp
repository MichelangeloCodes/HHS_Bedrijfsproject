...
#include "my_interfaces/msg/detail/custom__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::Custom;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::Custom *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::Custom *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_Custom__handle;
}
