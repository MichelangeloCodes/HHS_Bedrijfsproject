...
#include "my_interfaces/msg/detail/custom__rosidl_typesupport_fastrtps_c.h"
...
using _Custom__ros_msg_type = my_interfaces__msg__Custom;
...
size_t get_serialized_size_my_interfaces__msg__Custom(
  const void * untyped_ros_message,
...
static uint32_t _Custom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__Custom(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__msg__Custom(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces__msg__Custom;
    is_plain =
      (
...
static size_t _Custom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__msg__Custom(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, Custom)() {
