...
bool my_interfaces__msg__custom__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._custom.Custom", full_classname_dest, 32) == 0);
  }
  my_interfaces__msg__Custom * ros_message = _ros_message;
  {  // data
...
PyObject * my_interfaces__msg__custom__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._custom");
